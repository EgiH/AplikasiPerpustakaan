...
public class Karyawan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM ENTRY KARYAWAN");
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        String ID="", nama="", tempat_lahir="", jabatan="", tanggal_lahir, tanggal_masuk;
    ...
    private void tb_karyawanMouseClicked(java.awt.event.MouseEvent evt) {                                          
    ...
    private void bnt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnt_updateActionPerformed
        ...
        if (tanggal_lahir==null){
            ...
            String sql="update tb_karyawan set nama=?, tempat_lahir=?, tanggal_lahir=?, jabatan=?, tanggal_masuk=? where ID='"+ID+"'";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int ok=JOptionPane.showConfirmDialog(null,"Apakah Anda yakin ingin menghapus data Mahasiswa BP : "+ID+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
        if(ok==0){
            try{
    ...
    private void kliktable(){
        int baris = tb_karyawan.getSelectedRow();
        txt_ID.setText((String)tb_karyawan.getValueAt(baris, 0));
        txt_nama.setText((String)tb_karyawan.getValueAt(baris, 1));
        txt_tempat_lahir.setText((String)tb_karyawan.getValueAt(baris, 2));
        //txt_tanggal_lahir.setDate((Date)tb_karyawan.getValueAt(baris, 3));
        t_tgl_lahir.setText((String)tb_karyawan.getValueAt(baris, 3));
        txt_jabatan.setText((String)tb_karyawan.getValueAt(baris, 4));
        //txt_tanggal_masuk.setDate((Date)tb_karyawan.getValueAt(baris, 5));
        t_tgl_masuk.setText((String)tb_karyawan.getValueAt(baris, 5));
    }
    
    private DefaultTableModel tabmode;
    
    //menampilkan data dari datatabe ke tabel
    public void tampil_tb_karyawan(){
        Object []baris = {"NIM","Nama","Tempat Lahir","Tanggal Lahir","Jurusan","Tanggal Masuk"};
        tabmode = new DefaultTableModel(null, baris);
        tb_karyawan.setModel(tabmode);
        Connection con = new koneksi_2().getConnection();
        try {
            String sql = "select * from tb_karyawan order by ID asc";
            ...
            while (hasil.next()){
                ...
                String[] data = {ID, nama, tempat_lahir, tanggal_lahir, jabatan, tanggal_masuk};
                tabmode.addRow(data);
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mahasiswa dialog = new Mahasiswa(new javax.swing.JFrame(), true);
