...
public class Peminjaman extends javax.swing.JDialog {
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        String NPM="", nama="", jurusan="", kode_buku="", judul_buku="", tanggal_terbit="", tanggal_pinjam="";
        NPM = txt_NPM.getText();
    ...
    public void cari_mahasiswa() {
        ...
        NPM =txt_NPM.getText(); 
        Connection con = new koneksi_2().getConnection();
        String sql = "select * from tb_mahasiswa where NPM='"+NPM+"'";
        try {
