...
public class Mahasiswa extends javax.swing.JDialog {

    public Mahasiswa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampil_tb_mahasiswa();
    }

    Mahasiswa(Peminjaman aThis, boolean rootPaneCheckingEnabled) {
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        String NPM="", nama="", tempat_lahir="", jurusan="", tanggal_lahir, tanggal_masuk;
    ...
    private void bnt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnt_updateActionPerformed
        ...
        if (tanggal_lahir==null){
            ...
            String sql="update tb_mahasiswa set nama=?, tempat_lahir=?, tanggal_lahir=?, jurusan=?, tanggal_masuk=? where NPM='"+NPM+"'";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        String NPM = tabmode.getValueAt(baris, 0).toString();        
        int ok=JOptionPane.showConfirmDialog(null,"Apakah Anda yakin ingin menghapus data Mahasiswa BP : "+NPM+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
        if(ok==0){
            try{
                //panggil method koneksi
                Connection con = new koneksi_2().getConnection();
                String sql="delete from tb_mahasiswa where NPM='"+NPM+"'";
    ...
    private void kliktable(){
        int baris = tb_mahasiswa.getSelectedRow();
        txt_NPM.setText((String)tb_mahasiswa.getValueAt(baris, 0));
